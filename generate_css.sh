...
echo "/* Auto generated with generate_css.sh, do not modify */" > include/HTTP/Assets/Style.h
printf "const char STYLE_CSS[] PROGMEM = R\"raw(%s)raw\";" \
"`python3 -m csscompressor  assets/css/style.css`" \
 >> include/HTTP/Assets/Style.h

echo "/* Auto generated with generate_css.sh, do not modify */" > include/HTTP/Assets/PureCSS.h
printf "const char PURE_CSS[] PROGMEM = R\"raw(%s)raw\";" \
"`python3 -m csscompressor  assets/css/pure-css.css`" \
